...
btn_barras = ttk.Button(frame_controle, text = 'Gráfico de barras')
btn_barras.grid(row=0,padx=5,pady=5)


btn_linhas = ttk.Button(frame_controle, text = 'Gráfico de linhas')
btn_linhas.grid(row=1,padx=5,pady=5)


btn_pizza = ttk.Button(frame_controle, text = 'Gráfico de pizza')
btn_pizza.grid(row=2,padx=5,pady=5)

btn_tendencia = ttk.Button(frame_controle, text = 'Gráfico de tendência')
btn_tendencia.grid(row=3,padx=5,pady=5)

btn_descricao = ttk.Button(frame_controle, text = 'Gráfico de descrição')
btn_descricao.grid(row=4,padx=5,pady=5)

btn_previsao = ttk.Button(frame_controle, text = 'Gráfico de previsão')
